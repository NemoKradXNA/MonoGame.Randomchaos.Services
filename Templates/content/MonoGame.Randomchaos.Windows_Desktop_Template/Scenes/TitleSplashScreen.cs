...
namespace MonoGame.Randomchaos.Windows_Desktop_Template.Scenes
{
    public class TitleSplashScreen : SceneFadeBase
    {
        ...
        public TitleSplashScreen(Game game, string name, string nextScene, string audioAsset) : base(game, name, audioAsset) { NextScene = nextScene; }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            _spriteBatch.Draw(Game.Content.Load<Texture2D>("Textures/Logo/GameLogo"),
